...
public class Celular extends disp_elect{
	...
	public Celular(String marca, String color, String tipo_pantalla, String nombre_modelo, String tipo_camara,
			int pixeles, int iMEI, String numero_modelo) {
